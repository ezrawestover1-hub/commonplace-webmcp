...
**[Open Commonplace](https://commonplace-webmcp.pages.dev/)** — the current public HTTPS judge build, verified in ChatGPT’s in-app browser with native WebMCP tools.
